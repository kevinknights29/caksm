...
def mark_better(ax, direction: str, loc: str = "upper left", length: float = 0.13,
    ...
    """Mark which way is better on the y-axis: a short arrow labelled "better".
    ...
    When no corner is free, pass at=(x, y_centre) in axes fraction to place the
    ...
    ax.annotate("", xy=(x, tip), xytext=(x, tail), xycoords="axes fraction",
                ...
                arrowprops=dict(arrowstyle="-|>", color=color, lw=1.1,
                                shrinkA=0, shrinkB=0))
    # Centre the label on its own anchor (default rotation_mode aligns, then rotates
